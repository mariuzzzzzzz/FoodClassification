package ch.zhaw.deeplearningjava.food;
...
public final class Training {
    ...
    public static void main(String[] args) throws IOException, TranslateException {
        ...
        // ImageFolder dataset = initDataset("food-101-small");
        ImageFolder dataset = initDataset("food-101-small");
    ...
    private static ImageFolder initDataset(String datasetRoot)
        ...
        ImageFolder dataset = ImageFolder.builder()
                ...
                .optMaxDepth(10)
                .addTransform(new Resize(Models.IMAGE_WIDTH, Models.IMAGE_HEIGHT)) // Image verkleinern für bessere Performance
